...
if __name__ == "__main__":
    ...
    unipose2_params["upper_range"] = input_max_range[int(sys.argv[3])]
    
    model_types = [Baseline, Unipose, DeciWatch, Unipose2][int(sys.argv[1])]
    model_params = [baseline_params, unipose_params, deciwatch_params, unipose2_params][int(sys.argv[1])]
