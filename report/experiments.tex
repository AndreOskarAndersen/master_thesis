...
\begin{table}[htbp]
    ...
    \textbf{Models}                                                            & \rot{\textbf{Nose}} & \rot{\textbf{Ears}} & \rot{\textbf{Shoulders}} & \rot{\textbf{Elbows}} & \rot{\textbf{Wrists}} & \rot{\textbf{Pinkies}} & \rot{\textbf{Index fingers}} & \rot{\textbf{Thumbs}} & \rot{\textbf{Hips}} & \rot{\textbf{Knees}} & \rot{\textbf{Ankles}} & \rot{\textbf{Heels}} & \rot{\textbf{Feet}} & \rot{\textbf{Total}} \\ \hline
    \textbf{\begin{tabular}[c]{@{}c@{}}Conv3D\\ 1.1\end{tabular}}              &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}Conv3D\\ 1.2\end{tabular}}              &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               & .97          \\
    \textbf{\begin{tabular}[c]{@{}c@{}}Conv3D\\ 1.3\end{tabular}}              &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               & .94          \\
    \textbf{\begin{tabular}[c]{@{}c@{}}DeciWatch\\ 1.1\end{tabular}}           &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}DeciWatch\\ 1.2\end{tabular}}           &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}DeciWatch\\ 1.3\end{tabular}}           &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}bi-ConvLSTM\\ sum 1.1\end{tabular}}     &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}bi-ConvLSTM\\ sum 1.2\end{tabular}}     &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}bi-ConvLSTM\\ sum 1.3\end{tabular}}     &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}bi-ConvLSTM\\ concat. 1.1\end{tabular}} &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               & .94          \\
    \textbf{\begin{tabular}[c]{@{}c@{}}bi-ConvLSTM\\ concat. 1.2\end{tabular}} &               &               &                    &                 &                 &                  &                        &                 &               &                &                 &                &               &                \\
    \textbf{\begin{tabular}[c]{@{}c@{}}bi-ConvLSTM\\ concat. 1.3\end{tabular}} & .00         & .00         & .00              & .00           & .00           & .00            & .00                  & .00           & .00         & .00          & .00           & .00          & .00         &                \\ \hline
    \end{tabular}
    \caption{Testing results of the pretraining.}
    \label{tab:pretrain_res}
\end{table}
