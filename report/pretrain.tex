...
\begin{table}[htbp]
    \begin{adjustbox}{center}
        \begin{tabular}{c||ccc|ccc|ccc|ccc|c}
            ...
            \hline
        \end{tabular}
        \caption{Keypoint-specific testing PCK@0.1-accuracies of the various models for shiting-scalar $s = 1$. All the accuracies are in percentage.}
